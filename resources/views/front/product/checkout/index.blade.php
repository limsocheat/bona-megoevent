        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    @endif
                    <div class="col-md-6">
                        {!! Form::model($user, ['route' => 'checkout.paypal.submit', 'method' => 'POST']) !!}
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-text">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            name', 'class' => 'form-control', 'readonly' => false, 'required' => true]) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-group">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        'class' => 'form-control', 'readonly' => false, 'required' => true]) !!}
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        => 'form-control', 'readonly' => false, 'required' => true]) !!}
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <div class="form-group">
