...
=======
    <div class="row">
        <div class="col-md-6">
            <h1 class="float-left">Edit Event</h1>
            <div
                class="mego-btn {{ $event->status == 'published' ? 'btn-success' : 'mego-outline-gold text-capitalize'  }} float-left ml-5">
                {{ $event->status }}</div>
        </div>
        <div class="col-md-6 text-right">
            @if ($event->payment)
            You have paid <strong>{{ Money::SGD($event->payment->total) }}</strong>
            @else
            <a href="{{ route('manage.event_payment.create') }}?event_id={{ $event->id }}" class="btn
            mego-gold-bg">Make
                Payment & Publish</a>
            @endif
        </div>
...
=======
                    ...
                    <div class="col-md-12 pt-3">
                        ...
                        <div class="form-group mb-3">
                            <div class="preview-wrapper" id="profile-preview">
                                {{-- <img id="feature-image-previewer" class="preview-img"
                                        src="{{  asset('/images/event_feature_image_placeholder.png') }}" alt="Preview
                                Image" width="358"
                                height="141" /> --}}
                                <img src="{{ $event->imageUrl ? $event->imageUrl : asset('/images/event_feature_image_placeholder.png') }}"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        'id' => 'StartDate', 'readonly' => $event->readonly]) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        => 'EndDate', 'readonly' => $event->readonly]) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="tab-pane" id="fee" role="tabpanel" aria-labelledby="fee-tab">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        {!! Form::label('group_min_pax', 'Group Price Minimum No of Pax') !!}
                        {!! Form::number('group_min_pax', null, ['placeholder' => 'Group Price Minimum No of Pax',
                        'class' => 'form-control']) !!}
                    </div>
                </div>
            </div>
